...
export class AuthRepository {
    ...
    async findIdentity(providerId, providerUid) {
     ...
     */
    async linkIdentity(userId, providerId, providerUid, tokenData) {
     ...
     */
    async createUserWithIdentity(userData, identityData) {
    ...
    async setSelectedAvatar(userId, avatarId) {
        return prisma.$transaction(async (tx) => {
    ...
    async deleteIdentityAndAvatar(userId, providerName) {
