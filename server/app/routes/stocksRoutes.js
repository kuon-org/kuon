 ...
 *         description: 未ログイン
 */
stockRouter.get("/stocks/mylists", authenticateToken, stockCtrl.getMyStockLists);
/**
 * @openapi
 * /api/stocks/alllists:
 *   get:
 ...
 *         description: 未ログイン
 */
stockRouter.get("/stocks/alllists", authenticateToken, stockCtrl.getMyAllStockListDetail);
/**
 * @openapi
 * /api/stocks/lists:
 *   post:
 ...
 *         description: 権限なし
 */
stockRouter.post("/stocks/lists/:listId/articles", authenticateToken, stockCtrl.toggleArticleInList);
/**
 * @openapi
 ...
 */
stockRouter.post("/stocks/default/articles", authenticateToken, stockCtrl.toggleDefaultStock);
/**
 * @openapi
 ...
 *         description: 見つかりません
 */
stockRouter.get("/stocks/lists/:listId", optionalAuth, stockCtrl.getStockListDetail);
/**
 * @openapi
 * /api/stocks/lists/{listId}:
 *   patch:
 ...
 *         description: 未ログイン
 */
stockRouter.patch("/stocks/lists/:listId", authenticateToken, stockCtrl.updateStockList);
/**
 * @openapi
 * /api/stocks/lists/{listId}:
 *   delete:
 ...
 *         description: 未ログイン
 */
stockRouter.delete("/stocks/lists/:listId", authenticateToken, stockCtrl.deleteStockList);
/**
 * @openapi
 ...
 *         description: 未ログイン
 */
stockRouter.post("/stocks/lists/:listId/like", authenticateToken, stockCtrl.toggleLike);
/**
 * @openapi
 ...
 *         description: 未ログイン
 */
stockRouter.get("/stocks/lists/:listId/islike", authenticateToken, stockCtrl.getIsLiked);
