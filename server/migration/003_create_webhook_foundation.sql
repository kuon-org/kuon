...
CREATE TABLE IF NOT EXISTS knowledge.webhook_events (
...
CREATE INDEX IF NOT EXISTS idx_webhook_events_event_type
    ON knowledge.webhook_events(event_type);
...
COMMENT ON TABLE knowledge.webhook_events IS 'Webhookが購読するイベント';
