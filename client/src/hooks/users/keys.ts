export const userKeys = {
  ...
  followingState: (userId?: string) => [...userKeys.all, "following-state", userId] as const,
  ...
  commentCount: (userId?: string) => [...userKeys.all, "comment-count", userId] as const,
  articleCount: (userId?: string) => [...userKeys.all, "article-count", userId] as const,
