export const articleKeys = {
  ...
  ownership: (articleId: string) => [...articleKeys.all, "ownership", articleId] as const,
  likeUsers: (articleId: string) => [...articleKeys.all, "likes", articleId] as const,
  isLiked: (articleId: string) => [...articleKeys.all, "is-liked", articleId] as const,
