...
const Dashboard = lazy(() =>
  import("../pages/Admin/Dashboard").then((mod) => ({
...
const ServerSettings = lazy(() =>
  import("../pages/Admin/ServerSettings").then((mod) => ({
    default: mod.ServerSettings,
  })),
);
...
const RoleManagement = lazy(() =>
  import("../pages/Admin/RoleManagement").then((mod) => ({
    default: mod.RoleManagement,
  })),
);
...
const Webhooks = lazy(() =>
  import("../pages/Admin/Webhooks").then((mod) => ({ default: mod.Webhooks })),
);
const ServerEvents = lazy(() =>
  import("../pages/Admin/ServerEvents").then((mod) => ({
    default: mod.ServerEvents,
  })),
);
...
export const adminServerEventsRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "server-events",
  component: () => (
    <Suspense fallback={<LoadingFallback />}>
...
export const adminRoleManagementRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "roles",
  component: () => (
    <Suspense fallback={<LoadingFallback />}>
