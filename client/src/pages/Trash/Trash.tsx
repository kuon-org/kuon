      ...
      <Paper sx={{ p: 3 }}>
        ...
        <List>
          {trashQuery.isLoading ? (
            <ListItem>
              <ListItemText primary={t("trash.loading")} />
            </ListItem>
          ) : (
              ...
              <ListItem key={article.id} divider>
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  <Button
                    ...
                    variant="contained"
                    color="success"
                    onClick={() => restoreArticle.mutate(article.id)}
                  >
                    {t("trash.restore")}
                  </Button>
                  <Button
                    ...
                    color="error"
                    onClick={() => {
                      if (window.confirm(t("trash.hardDeleteConfirm")))
          ...
          {!trashQuery.isLoading && articles.length === 0 && (
