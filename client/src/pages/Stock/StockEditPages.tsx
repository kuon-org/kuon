  ...
  return (
    <Paper sx={{ p: 4, borderRadius: 2 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Typography variant="h6" color="text.secondary" mb={3}>{isEdit && !isSystem && <Button color="error" onClick={handleDelete} disabled={deleteList.isPending}>{t("stock.edit.delete")}</Button>}</Typography>
      </Box>
