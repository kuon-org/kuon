...
export const Webhooks = () => {
  ...
  if (metadataQuery.isLoading)
    return <Typography>{t("webhooks.metadataLoading")}</Typography>;
  if (metadataQuery.isError)
    return (
      <Box sx={{ width: "100%", maxWidth: 760 }}>
        ...
        <Alert severity="info">{t("webhooks.unavailable")}</Alert>
      </Box>
    );
    ...
    <Box sx={{ width: "100%", maxWidth: 900, pb: 8 }}>
      ...
      <Stack spacing={2}>
                ...
                <Paper key={webhook.id} variant="outlined" sx={{ p: 1.5 }}>
                  ...
                  >
                    ...
                    <Stack direction="row" alignItems="center">
                      ...
                      />
                      <Tooltip title={t("webhooks.editAction")}>
                        <IconButton onClick={() => loadWebhook(webhook.id)}>
                          <Edit />
                        </IconButton>
                      </Tooltip>
                      <Tooltip title={t("webhooks.deleteAction")}>
                        <IconButton
                          color="error"
        ...
        <Stack direction="row" spacing={1} flexWrap="wrap">
          <Button
            variant="contained"
            disabled={saveWebhook.isPending || !!jsonError || !event || !name}
            onClick={async () => {
          ...
          <Button
            disabled={previewPayload.isPending || !!jsonError}
            onClick={async () =>
              setPreview(
                (
          ...
          <Button
            disabled={testSend.isPending || !url || !!jsonError}
            onClick={async () =>
              setTestResult(
