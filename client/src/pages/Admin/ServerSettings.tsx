      ...
      {settingsQuery.isLoading ? (
        ...
        <>
          <Typography variant="h5" sx={{ mb: 1 }}>
            {t("serverSettings.maintenance.title")}
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            {t("serverSettings.maintenance.description")}
          </Typography>
          {sourceAlert(maintenanceSetting?.readOnly)}
          {maintenanceMode && (
            <Alert severity="warning" sx={{ mb: 2 }}>
              {t("serverSettings.maintenance.warning")}
            </Alert>
          )}
          <FormControlLabel
            control={
              <Switch
                ...
                disabled={
                  maintenanceSetting?.readOnly || updateServerSetting.isPending
                }
              />
            }
            label={maintenanceMode ? t("common.enabled") : t("common.disabled")}
          />
          <Divider sx={{ my: 3 }} />
          <Typography variant="h5" sx={{ mb: 1 }}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            {t("serverSettings.notifications.description")}
          </Typography>
          ...
          <Divider sx={{ my: 3 }} />
          <Typography variant="h5" sx={{ mb: 1 }}>
            {t("serverSettings.webhooks.title")}
          </Typography>
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            {t("serverSettings.webhooks.description")}
          </Typography>
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(event) =>
                  updateBooleanSetting("webhooks_enabled", event.target.checked)
                }
                disabled={
                  webhooksSetting?.readOnly || updateServerSetting.isPending
                }
              />
            }
            label={
              webhooksEnabled ? t("common.allowed") : t("common.notAllowed")
            }
          />
          <Box sx={{ mt: 2, ml: 2 }}>
            <Typography variant="subtitle1" sx={{ mb: 0.5 }}>
              {t("serverSettings.webhooks.userTitle")}
            </Typography>
            <Typography variant="body2" color="text.secondary" sx={{ mb: 1 }}>
              {t("serverSettings.webhooks.userDescription")}
            </Typography>
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  disabled={
                    !webhooksEnabled ||
                    allowUserWebhooksSetting?.readOnly ||
                    updateServerSetting.isPending
                  }
                />
              }
              label={
                allowUserWebhooks ? t("common.allowed") : t("common.notAllowed")
              }
            />
          </Box>
          <Divider sx={{ my: 3 }} />
