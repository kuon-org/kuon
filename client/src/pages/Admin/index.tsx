import { Avatar, Box, Container, List, ListItemButton, ListItemText, Typography } from "@mui/material"
import { Link, Navigate, Outlet, useLocation, useNavigate } from "@tanstack/react-router"
import { adminRoute, adminSecurityRoute, adminTopRoute, adminUserManagementRoute } from "../../router";
...
export const AdminIndex = () => {
    ...
    return (
        <Box>
            ...
            >
                <Box sx={{ display: "flex" }}>
                    <Avatar src={undefined} sx={{ width: 48, height: 48, bgcolor: "grey.200" }} />
                    <Typography variant="h4" ml={1}>{selectedLabel ? `${selectedLabel} - KUON` : "KUON"}</Typography>
                </Box>
            </Link>
            <Container
                sx={{
