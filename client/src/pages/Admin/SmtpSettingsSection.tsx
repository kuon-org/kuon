...
export const SmtpSettingsSection = () => {
  ...
  const handleSave = async () => {
    ...
    setError(null);
    try {
      await updateSmtpSettings.mutateAsync({
        host,
        port: Number(port),
        secure,
        username,
  ...
  if (smtpSettingsQuery.isLoading)
    return (
    ...
    <Box>
      ...
      <Stack spacing={2}>
        ...
        <TextField
          ...
          placeholder={
            smtpSettings?.passwordConfigured ? t("smtp.passwordConfigured") : ""
          }
          helperText={
            readOnly
              ? t("smtp.secretHidden")
      ...
      <Box sx={{ mt: 3 }}>
        ...
        <Stack direction={{ xs: "column", sm: "row" }} spacing={1}>
          ...
          <Button
            ...
            onClick={handleTest}
            disabled={
              !smtpSettings?.configured || !testTo || sendSmtpTest.isPending
            }
