...
export const UserManagement = () => {
  ...
  const handleToggleActive = () => {
    ...
    toggleUserActive.mutate(selectedUser.id);
    handleMenuClose();
  };
  ...
  const columns: GridColDef[] = [
    ...
    {
      field: "is_active",
      headerName: t("users.statusAndRoles"),
      width: 280,
      renderCell: (params) => {
        ...
        return (
          ...
          >
            ...
            {assignedRoles.length > 2 && (
              <Chip label={`+${assignedRoles.length - 2}`} size="small" />
            )}
          </Stack>
        );
      },
    ...
    {
      field: "last_login_at",
      headerName: t("users.lastLoginAt"),
      width: 150,
      valueFormatter: (value) =>
        value ? dateFormatter.format(new Date(value)) : "",
    },
    ...
    <>
      ...
      >
        ...
        {canAssignRoles && (
          <MenuItem onClick={openRoleDialog}>
            ...
            <ListItemText>{t("users.configureRoles")}</ListItemText>
          </MenuItem>
        )}
      </Menu>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            variant="contained"
            disabled={assignRoles.isPending || selectedRoleIds.length === 0}
