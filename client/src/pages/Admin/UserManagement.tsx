...
import { userProfileIndexRoute } from "../../router";
        ...
        },
        {
            ...
            renderCell: (params) => (
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                    ...
                    >
                        <SettingsIcon fontSize="small" /><ArrowDropDownIcon fontSize="small" />
                    </IconButton>
                </Box>
            )
        },
    ...
    return (
        ...
        >
            ...
            <Stack direction="row" spacing={4} sx={{ mb: 3 }}>
                <Box>
                    <Typography variant="caption" color="text.secondary">総ユーザ数</Typography>
                    <Typography variant="h6">{totalCount}</Typography>
                </Box>
                <Box>
                    <Typography variant="caption" color="text.secondary">アクティブ</Typography>
                    <Typography variant="h6" color="success.main">{activeCount}</Typography>
                </Box>
                <Box>
                    <Typography variant="caption" color="text.secondary">非アクティブ</Typography>
                    <Typography variant="h6" color="error.main">{inactiveCount}</Typography>
                </Box>
            </Stack>
