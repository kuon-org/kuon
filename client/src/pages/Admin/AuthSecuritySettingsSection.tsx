...
export const AuthSecuritySettingsSection = () => {
  ...
  return (
    <>
      ...
      <FormControlLabel
        control={<Switch checked={requireAuthentication} onChange={(event) => updateBooleanSetting("require_authentication", event.target.checked)} disabled={updateServerSetting_isPending} />}
      ...
      <FormControlLabel
        control={<Switch checked={allowLocalAccountRegistration} onChange={(event) => updateBooleanSetting("allow_local_account_registration", event.target.checked)} disabled={updateServerSetting_isPending} />}
      ...
      <FormControlLabel
        control={<Switch checked={requireTotpForExternalIdp} onChange={(event) => updateBooleanSetting("require_totp_for_external_idp", event.target.checked)} disabled={updateServerSetting_isPending} />}
      ...
      <FormControlLabel
        control={<Switch checked={allowApiKey} onChange={(event) => updateBooleanSetting("allow_api_key", event.target.checked)} disabled={updateServerSetting_isPending} />}
