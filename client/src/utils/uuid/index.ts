...
export const uuidv3 = (name: string, namespace: UUID): UUID =>
  toUUID(v3(name, namespace));
export const uuidv4 = (): UUID => toUUID(v4());
export const uuidv5 = (name: string, namespace: UUID): UUID =>
  toUUID(v5(name, namespace));
