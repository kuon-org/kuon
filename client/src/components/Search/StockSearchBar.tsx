    ...
    >
      ...
      >
        <MenuItem onClick={() => insertPrefix("tag:")}>
          ...
          <ListItemText>{t("stock.searchTag")}</ListItemText>
        </MenuItem>
        <MenuItem onClick={() => insertPrefix("user:")}>
          <ListItemIcon>
            <PersonIcon fontSize="small" />
          </ListItemIcon>
          <ListItemText>{t("stock.searchUser")}</ListItemText>
        </MenuItem>
        <MenuItem onClick={() => insertPrefix("title:")}>
          <ListItemText sx={{ ml: 4 }}>{t("stock.searchTitle")}</ListItemText>
        </MenuItem>
        <MenuItem onClick={() => insertPrefix("created:>=")}>
          <ListItemText sx={{ ml: 4 }}>{t("stock.searchCreated")}</ListItemText>
        </MenuItem>
        <MenuItem onClick={() => insertPrefix("updated:>=")}>
          <ListItemText sx={{ ml: 4 }}>{t("stock.searchUpdated")}</ListItemText>
        </MenuItem>
      </Menu>
    </Paper>
  );
