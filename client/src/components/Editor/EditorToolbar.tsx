...
export const EditorToolbar = ({
  ...
  const mainButtons = [
    ...
    { icon: <Timeline />, type: "drawio", label: "図解(Draw.io)" },
    ...
    >
      <Box onMouseLeave={() => setHeadingAnchor(null)}>
        <Tooltip title="見出し" arrow>
          <IconButton
            size="small"
            onMouseEnter={(e) => setHeadingAnchor(e.currentTarget)}
            sx={normalStyle}
          >
            <FormatSize />
          </IconButton>
        ...
        <>
          <Tooltip title="エディタのみ" arrow>
            <IconButton
              ...
              sx={viewMode === "editor" ? activeStyle : normalStyle}
            >
              <ViewHeadline />
            </IconButton>
          </Tooltip>
          <Tooltip title="分割表示" arrow>
            <IconButton
              ...
              sx={viewMode === "split" ? activeStyle : normalStyle}
            >
              <VerticalSplit />
            </IconButton>
          </Tooltip>
          <Tooltip title="プレビューのみ" arrow>
            <IconButton
              ...
              sx={viewMode === "preview" ? activeStyle : normalStyle}
            >
              <Visibility />
            </IconButton>
          </Tooltip>
      ...
      <Tooltip title={isFullscreen ? "全画面解除" : "全画面表示"} arrow>
        <IconButton
          ...
          sx={isFullscreen ? activeStyle : normalStyle}
        >
      ...
      <Tooltip title={isSync ? "スクロール同期ON" : "スクロール同期OFF"} arrow>
        <IconButton
          ...
          sx={isSync ? activeStyle : normalStyle}
        >
