      ...
      >
        <Box>
          ...
          >
            ...
            <Typography component="span" color="error" variant="caption">
              {t("stock.create.required")}
            </Typography>
          </FormLabel>
          <TextField
            fullWidth
            size="small"
            placeholder={t("stock.create.namePlaceholder")}
            value={name}
        ...
        <Box>
          ...
          <TextField
            ...
            rows={2}
            size="small"
            placeholder={t("stock.create.descriptionPlaceholder")}
            value={description}
